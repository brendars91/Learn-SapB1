...
export const I18N = {
  es: {
    ...
    importError: 'Archivo rechazado por esquema o privacidad.', importOk: 'Progreso sintético importado.', exportOk: 'Progreso exportado.', resetConfirm: 'El progreso local se ha reiniciado.', resetAsk: '¿Reiniciar TODO el progreso? Esta acción no se puede deshacer.',
    ...
    accountNotice: 'Números de cuenta: ejemplos sintéticos. El plan contable real y la determinación de cuentas dependen de la localización y de la parametrización de tu empresa.',
    ...
    crActiveCase: 'EXPEDIENTE ACTIVO', crKpiCompany: 'KPIs de SYN-Nordlicht', crDeskRole: 'Cargo',
    chainFact: 'HECHO', chainEvidence: 'EVIDENCIA', chainHypothesis: 'HIPÓTESIS DESCARTADA', chainAction: 'ACCIÓN SEGURA', chainVerify: 'VERIFICACIÓN', chainSource: 'FUENTE', chainTitle: 'Cadena forense del expediente', chainOpen: 'Abrir expediente',
  ...
  en: {
    ...
    importError: 'File rejected by schema or privacy policy.', importOk: 'Synthetic progress imported.', exportOk: 'Progress exported.', resetConfirm: 'Local progress has been reset.', resetAsk: 'Reset ALL progress? This cannot be undone.',
    ...
    accountNotice: 'Account numbers are synthetic examples. The actual chart of accounts and G/L account determination depend on your localization and company configuration.',
    ...
    crActiveCase: 'ACTIVE CASE', crKpiCompany: 'SYN-Nordlicht KPIs', crDeskRole: 'Role',
    chainFact: 'FACT', chainEvidence: 'EVIDENCE', chainHypothesis: 'RULED-OUT HYPOTHESIS', chainAction: 'SAFE ACTION', chainVerify: 'VERIFICATION', chainSource: 'SOURCE', chainTitle: 'Case forensic chain', chainOpen: 'Open case file',
  ...
  de: {
    ...
    importError: 'Datei wegen Schema oder Datenschutz abgelehnt.', importOk: 'Synthetischer Fortschritt importiert.', exportOk: 'Fortschritt exportiert.', resetConfirm: 'Lokaler Fortschritt wurde gelöscht.', resetAsk: 'Gesamten Fortschritt zurücksetzen? Kann nicht rückgängig gemacht werden.',
    ...
    accountNotice: 'Kontonummern sind synthetische Beispiele. Der tatsächliche Kontenplan und die Kontenfindung hängen von Lokalisierung und Konfiguration deines Unternehmens ab.',
    ...
    crActiveCase: 'AKTIVER VORGANG', crKpiCompany: 'SYN-Nordlicht-KPIs', crDeskRole: 'Rolle',
    chainFact: 'FAKT', chainEvidence: 'BELEG', chainHypothesis: 'AUSGESCHLOSSENE HYPOTHESE', chainAction: 'SICHERE MASSNAHME', chainVerify: 'PRÜFUNG', chainSource: 'QUELLE', chainTitle: 'Forensische Kette des Vorgangs', chainOpen: 'Vorgang öffnen',
