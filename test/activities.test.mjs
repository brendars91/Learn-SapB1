...
import { SKILLS } from 'file:///tmp/b1repo/src/content.mjs';
import { MASTERCLASS } from 'file:///tmp/b1repo/src/masterclass.mjs';
import { getActivity, ACTIVITY_COUNTS } from 'file:///tmp/b1repo/src/activities.mjs';
